...
const Routing = () => {
	return (
		<div>
			<h2>Routing</h2>
			<p>CMS use <a href="https://reactrouter.com/" target="_blank" rel="noopener noreferrer">react-router</a> as base routing system. To add a new route in the template, you can follow the steps below.</p>
			<div className="mt-4">
