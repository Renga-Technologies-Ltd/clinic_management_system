  ...
  return (
    <div>
      ...
      <div className="mt-4">
        ...
        <p class="mt-1">
          If you have wish to use mock api, you can follow the steps below to
	...
	return createServer({
        ...
        <p>
          And now you will get the mock data as response when you make request
          to <code>api/getUsers</code>
        </p>
      </div>
      <div className="mt-4">
        <h4>Disable mock api</h4>
        <p>
          Mock api was enable by default in our starter-kit, you can turn it off
          by remove code below in <code>App.js</code>
        </p>
        <SyntaxHighlighter
          className="hl-code"
          language="javascript"
