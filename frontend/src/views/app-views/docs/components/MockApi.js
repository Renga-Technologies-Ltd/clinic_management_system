...
const MockApi = () => {
	return (
		<div>
			<h2>Mock Api</h2>
			<p>Princenet uses <a href="https://miragejs.com/" target="_blank" rel="noreferrer">miragejs</a> for mocking API calls, all the api interaction in our demo are work under miragejs.</p>
			<div className="mt-4">
