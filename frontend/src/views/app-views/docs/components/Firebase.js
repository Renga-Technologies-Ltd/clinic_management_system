...
const firebase = () => {
	return (
		<div>
			<h2>Firebase</h2>
			<p>Princenet comes with Firebase integration and uses it as default authentication option in demo, you can use or remove it depend on your project fit.</p>
			<div className="mt-4">
