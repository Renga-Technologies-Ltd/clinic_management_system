...
export const APP_NAME = 'Princenet';
...
const TemplateSetting = () => {
	return (
		<div>
			...
			<p>Princenet comes with a variety of different theme & layout, you can try them from quick view panel in our demo and copy the config to your project.</p>
			<div className="mt-4">
