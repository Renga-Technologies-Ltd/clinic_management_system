      ...
      <Row gutter={16}>
              ...
              renderItem={(item) => (
                <List.Item>
                  <div className="d-flex align-items-center justify-content-between w-100">
                    <div>
                      <h4 className="font-weight-bold mb-0">{item.name}</h4>
                ...
                <List.Item>
                  <div className="d-flex align-items-center justify-content-between w-100">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ml-3">
                        <h4 className="font-weight-bold mb-0">{item.location}</h4>
        ...
        <Col xs={24} sm={24} md={24} lg={24} xxl={12}>
          <ChartWidget
            ...
            title="Fiber Signals and Light Intensity"
            height={410}
            type="bar"
            direction={direction}
            customOptions={{
