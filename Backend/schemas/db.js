...
mongoose.connection.on('connected',()=>{console.log('Database connected successfully at %s',dburl);});
mongoose.connection.on('error',(err) =>{console.log('Database connection failed with err %s',err);});
